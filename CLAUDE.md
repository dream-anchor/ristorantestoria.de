...
- Checkliste neue Seite:
  ...
  3. Eager import (kein `lazy()`)
  4. `npm run build` ok (128+ Routen, 0 Errors)
  5. HTML in `dist/` hat echten Content (kein "Laden...")
  6. `<title>`, `<meta description>`, hreflang, JSON-LD vorhanden
  7. Translations in allen 4 Sprachen
