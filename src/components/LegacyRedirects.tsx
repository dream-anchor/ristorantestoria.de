...
export const RedirectToWeihnachtsmenues = () => <Navigate to="/besondere-anlaesse/weihnachtsmenue/" replace />;
export const RedirectToSilvesterparty = () => <Navigate to="/besondere-anlaesse/silvester/" replace />;
