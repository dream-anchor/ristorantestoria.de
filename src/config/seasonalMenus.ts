...
export const SEASONAL_MENUS: SeasonalMenuConfig[] = [
  {
    ...
    slugs: {
      de: 'ostermontag-menue',
      en: 'easter-monday-menu',
      it: 'menu-di-pasqua',
      fr: 'menu-de-paques',
    },
    titles: {
      ...
      en: 'Easter Monday Menu',
      it: 'Men\u00f9 di Pasqua',
      fr: 'Menu du Lundi de P\u00e2ques',
    },
    placeholder: {
      de: 'Unser Ostermontag-Men\u00fc wird bald ver\u00f6ffentlicht. Kontaktieren Sie uns f\u00fcr Reservierungen.',
      en: 'Our Easter Monday menu will be published soon. Contact us for reservations.',
      it: 'Il nostro men\u00f9 di Pasqua sar\u00e0 pubblicato a breve. Contattateci per prenotazioni.',
      fr: 'Notre menu du lundi de P\u00e2ques sera bient\u00f4t publi\u00e9. Contactez-nous pour r\u00e9server.',
    },
    expectedMonth: {
      de: 'M\u00e4rz',
      en: 'March',
    ...
    descriptions: {
      de: [
        'Feiern Sie Ostermontag mit einem festlichen Abendmen\u00fc im STORIA \u2013 Ihrem italienischen Restaurant in M\u00fcnchen Maxvorstadt. Genie\u00dfen Sie die Osterzeit in unserem stilvollen Ambiente mit einem mehrg\u00e4ngigen italienischen Men\u00fc.',
        'Unser Ostermen\u00fc verbindet die Lebensfreude der italienischen K\u00fcche mit saisonalen Fr\u00fchlingsaromen. Von hausgemachten Antipasti \u00fcber frische Pasta bis hin zu traditionellen Osterspezialit\u00e4ten \u2013 ein Genuss f\u00fcr Familie und Freunde.',
        'Reservieren Sie fr\u00fchzeitig, da die Pl\u00e4tze f\u00fcr das Ostermen\u00fc begrenzt sind. Gerne nehmen wir auch Anfragen f\u00fcr gr\u00f6\u00dfere Gruppen und Familienfeiern entgegen.',
      ],
      en: [
        'Celebrate Easter Monday with a festive dinner at STORIA \u2013 your Italian restaurant in Munich Maxvorstadt. Enjoy the Easter season in our elegant setting with a multi-course Italian menu.',
        'Our Easter menu combines the joy of Italian cuisine with seasonal spring flavors. From homemade antipasti to fresh pasta and traditional Easter specialties \u2013 a treat for family and friends.',
        'Book early as seating for our Easter Monday dinner is limited. We also welcome larger groups and family celebrations upon request.',
      ],
      it: [
        'Celebrate il Luned\u00ec dell\u2019Angelo con una cena festosa al STORIA \u2013 il vostro ristorante italiano a Monaco Maxvorstadt. Godetevi la Pasqua nel nostro elegante ambiente con un men\u00f9 italiano a pi\u00f9 portate.',
        'Il nostro men\u00f9 di Pasqua unisce la gioia della cucina italiana con i sapori primaverili di stagione. Dagli antipasti fatti in casa alla pasta fresca e alle specialit\u00e0 pasquali tradizionali \u2013 un piacere per tutta la famiglia.',
        'Prenotate in anticipo poich\u00e9 i posti per la nostra cena di Pasqua sono limitati. Accogliamo anche gruppi numerosi e celebrazioni in famiglia su richiesta.',
      ],
      fr: [
        'C\u00e9l\u00e9brez le lundi de P\u00e2ques avec un d\u00eener festif au STORIA \u2013 votre restaurant italien au c\u0153ur de Munich Maxvorstadt. Savourez la saison pascale dans notre cadre \u00e9l\u00e9gant avec un menu italien en plusieurs services.',
        'Notre menu de P\u00e2ques allie la joie de la cuisine italienne aux saveurs printani\u00e8res de saison. Des antipasti maison aux p\u00e2tes fra\u00eeches et aux sp\u00e9cialit\u00e9s de P\u00e2ques traditionnelles \u2013 un r\u00e9gal pour toute la famille.',
        'R\u00e9servez t\u00f4t car les places pour notre d\u00eener du lundi de P\u00e2ques sont limit\u00e9es. Nous accueillons \u00e9galement les grands groupes et les c\u00e9l\u00e9brations en famille sur demande.',
      ],
    },
    faq: {
      de: [
        { question: 'Wann findet das Ostermen\u00fc statt?', answer: 'Unser Ostermen\u00fc findet am Ostermontag abends statt. Die genauen Zeiten entnehmen Sie bitte der aktuellen Men\u00fcank\u00fcndigung.' },
        { question: 'Wie kann ich f\u00fcr das Ostermen\u00fc reservieren?', answer: 'Sie k\u00f6nnen telefonisch unter +49 89 51519696 oder per E-Mail an info@ristorantestoria.de reservieren. Fr\u00fchzeitige Reservierung wird empfohlen.' },
        { question: 'F\u00fcr wie viele Personen eignet sich das Ostermen\u00fc?', answer: 'Das Ostermen\u00fc eignet sich f\u00fcr Paare, Familien und kleine Gruppen. F\u00fcr gr\u00f6\u00dfere Gesellschaften erstellen wir gerne ein individuelles Angebot.' },
        { question: 'Was kostet das Ostermen\u00fc ungef\u00e4hr?', answer: 'Der Preis variiert je nach Men\u00fc. Orientieren Sie sich an der aktuellen Men\u00fcank\u00fcndigung oder kontaktieren Sie uns direkt.' },
        { question: 'Gibt es vegetarische Optionen beim Ostermen\u00fc?', answer: 'Ja, wir bieten eine Auswahl an vegetarischen Speisen. Bitte informieren Sie uns bei der Reservierung \u00fcber spezielle Ern\u00e4hrungsw\u00fcnsche.' },
      ],
      en: [
        { question: 'When does the Easter Monday dinner take place?', answer: 'Our Easter Monday dinner takes place on Easter Monday evening. Please check the current menu announcement for exact times.' },
        { question: 'How can I reserve for the Easter Monday menu?', answer: 'You can reserve by phone at +49 89 51519696 or by email at info@ristorantestoria.de. Early booking is recommended.' },
        { question: 'How many people is the Easter Monday menu suited for?', answer: 'The Easter menu is suitable for couples, families, and small groups. For larger parties, we are happy to create a custom offer.' },
        { question: 'What does the Easter Monday menu cost approximately?', answer: 'The price varies by menu. Please check the current menu announcement or contact us directly.' },
        { question: 'Are there vegetarian options?', answer: 'Yes, we offer a selection of vegetarian dishes. Please inform us of any dietary requirements when making your reservation.' },
      ],
      it: [
        { question: 'Quando si svolge la cena di Pasqua?', answer: 'La nostra cena di Pasqua si svolge la sera del Luned\u00ec dell\u2019Angelo. Consultate l\u2019annuncio del men\u00f9 attuale per gli orari esatti.' },
        { question: 'Come posso prenotare per il men\u00f9 di Pasqua?', answer: 'Potete prenotare telefonicamente al +49 89 51519696 o via email a info@ristorantestoria.de. Si consiglia la prenotazione anticipata.' },
        { question: 'Per quante persone \u00e8 adatto il men\u00f9 di Pasqua?', answer: 'Il men\u00f9 di Pasqua \u00e8 adatto a coppie, famiglie e piccoli gruppi. Per gruppi pi\u00f9 numerosi, siamo lieti di creare un\u2019offerta personalizzata.' },
        { question: 'Quanto costa approssimativamente il men\u00f9 di Pasqua?', answer: 'Il prezzo varia in base al men\u00f9. Consultate l\u2019annuncio del men\u00f9 attuale o contattateci direttamente.' },
        { question: 'Ci sono opzioni vegetariane?', answer: 'S\u00ec, offriamo una selezione di piatti vegetariani. Informateci di eventuali esigenze alimentari al momento della prenotazione.' },
      ],
      fr: [
        { question: 'Quand a lieu le menu du lundi de P\u00e2ques\u00a0?', answer: 'Notre d\u00eener de P\u00e2ques a lieu le lundi de P\u00e2ques au soir. Consultez l\u2019annonce du menu actuel pour les horaires exacts.' },
        { question: 'Comment puis-je r\u00e9server pour le menu de P\u00e2ques\u00a0?', answer: 'Vous pouvez r\u00e9server par t\u00e9l\u00e9phone au +49 89 51519696 ou par e-mail \u00e0 info@ristorantestoria.de. Une r\u00e9servation anticip\u00e9e est recommand\u00e9e.' },
        { question: 'Pour combien de personnes le menu de P\u00e2ques est-il adapt\u00e9\u00a0?', answer: 'Le menu de P\u00e2ques convient aux couples, aux familles et aux petits groupes. Pour les grands groupes, nous cr\u00e9ons volontiers une offre personnalis\u00e9e.' },
        { question: 'Quel est le prix approximatif du menu de P\u00e2ques\u00a0?', answer: 'Le prix varie selon le menu. Consultez l\u2019annonce du menu actuel ou contactez-nous directement.' },
        { question: 'Y a-t-il des options v\u00e9g\u00e9tariennes\u00a0?', answer: 'Oui, nous proposons une s\u00e9lection de plats v\u00e9g\u00e9tariens. Veuillez nous informer de tout besoin alimentaire sp\u00e9cial lors de votre r\u00e9servation.' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    faq: {
      de: [
        ...
        { question: 'Für wie viele Personen eignet sich das Restaurant?', answer: 'Wir bieten Platz für Gruppen von 2 bis 100 Personen (Sitzplätze), Stehempfänge bis 300 Personen. Dazu eine große Terrasse im Sommer. Für Firmen-Events und größere Feiern ist auch eine exklusive Nutzung möglich.' },
      ...
      en: [
        ...
        { question: 'How many people can the restaurant accommodate?', answer: 'We accommodate groups from 2 to 100 guests (seated), standing receptions up to 300 guests. Plus a large terrace in summer. Exclusive use of the restaurant is also available for corporate events and larger celebrations.' },
      ...
      it: [
        ...
        { question: 'Quante persone può ospitare il ristorante?', answer: "Ospitiamo gruppi da 2 a 100 persone (posti a sedere), ricevimenti in piedi fino a 300 persone. In estate anche una grande terrazza. Per eventi aziendali e grandi celebrazioni è disponibile anche l'uso esclusivo del ristorante." },
