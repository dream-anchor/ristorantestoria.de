/**
 * Admin Vormerkungen Page
 * Saisonale E-Mail-Vormerkungen (Valentinstag/Weihnachten/Silvester/Ostern) — Verwaltung + Versand
 */
...
export default function AdminVormerkungen() {
  ...
  return (
    <>
      <SEO
        title="Saisonale Vormerkungen - Admin"
        canonical="/admin/vormerkungen"
        noIndex={true}
      />
      ...
      {/* Main Content */}
      <main className="pt-12 container mx-auto px-4 pb-16">
        <DemoModeBanner />
