...
import heroImage600 from "@/assets/ristorante-storia-uebersicht-600w.webp";

const ItalienischesRestaurantMuenchen = () => {
  const { t } = useLanguage();
  usePrerenderReady(true);

  const s = t.seo.italienischesRestaurant;
  ...
  return (
    <>
      <SEO
        ...
        canonical="/italienisches-restaurant-muenchen"
      />
      ...
      <StructuredData
        ...
        breadcrumbs={[
          { name: 'Home', url: '/' },
          { name: s.breadcrumb, url: '/italienisches-restaurant-muenchen' }
        ]}
      />
...
export default ItalienischesRestaurantMuenchen;
