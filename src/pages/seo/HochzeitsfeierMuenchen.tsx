        ...
        <main className="flex-grow">
          ...
          <section className="py-16 md:py-20">
            <div className="container mx-auto px-4 max-w-5xl">
              ...
              <PhotoGallery images={[
                { src: eventSetupWeiss, srcSet: `${eventSetupWeiss600} 600w, ${eventSetupWeiss} 1400w`, sizes: "(max-width: 768px) 100vw, 50vw", alt: "Hochzeitsempfang im STORIA München — elegante Loggia mit weißen Stehtischen und Blumendekoration", caption: "Hochzeitsempfang · Loggia · weiße Dekoration" },
                { src: locationDetails, srcSet: `${locationDetails600} 600w, ${locationDetails} 1400w`, sizes: "(max-width: 768px) 100vw, 50vw", alt: "Ristorante STORIA München — Innenräume, Bar, Show-Kitchen und romantische Terrasse", caption: "Innenräume · Bar · Terrasse · Location-Details" },
              ]} />
            </div>
          </section>
