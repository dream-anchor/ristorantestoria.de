    ...
    <>
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
          <img src={menschenAussen} srcSet={`${menschenAussen600} 600w, ${menschenAussen} 1200w`} sizes="100vw" alt={tr.heroTitle} className="absolute inset-0 w-full h-full object-cover" loading="eager" fetchPriority="high" width={1200} height={800} />
        ...
        <main className="container mx-auto px-4 py-12 flex-grow">
          <article className="max-w-5xl mx-auto">
            ...
            {/* Rauchen-Vergleich (sekundäres Thema – nach den verkaufsstarken Sommer-Abschnitten) */}
            <section className="mb-16">
            ...
            {/* Zigarrenhändler (sekundäres Thema) */}
            ...
            <section className="mb-16">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <LocalizedLink to="oktoberfest-muenchen" className="bg-card border rounded-lg p-6 hover:border-primary transition-colors">
                  ...
                  <p className="text-muted-foreground text-sm">{t.seo?.besondereAnlaesse?.oktoberfestTeaser || "19. Sept – 4. Okt 2026 – Wiesnbier, Brotzeit & Specials auf der überdachten Terrasse. Ideal für Gruppen."}</p>
                </LocalizedLink>
