...
const ItalienerHauptbahnhofMuenchen = () => {
  ...
  const s = t.seo.italienerHauptbahnhof;

  const occasions = [
    { icon: UtensilsCrossed, title: s.occasionLunch, desc: s.occasionLunchDesc, link: "lunch-muenchen-maxvorstadt" },
    { icon: Wine, title: s.occasionDinner, desc: s.occasionDinnerDesc, link: "romantisches-dinner-muenchen" },
    { icon: CalendarDays, title: s.occasionEvents, desc: s.occasionEventsDesc, link: "firmenfeier-muenchen" },
  ...
  return (
    <>
      <SEO
        ...
        canonical="/italiener-hauptbahnhof-muenchen"
      />
      ...
      <StructuredData
        ...
        breadcrumbs={[
          { name: 'Home', url: '/' },
          { name: s.breadcrumb, url: '/italiener-hauptbahnhof-muenchen' }
        ]}
      />
            ...
            <div className="bg-black/40 backdrop-blur-sm rounded-2xl px-8 py-10 md:px-12 md:py-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90" asChild>
                  <LocalizedLink to="reservierung">{s.heroButton}</LocalizedLink>
                </Button>
            ...
            <div className="container mx-auto px-4 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" variant="secondary" asChild>
                  <LocalizedLink to="reservierung">{s.ctaButton}</LocalizedLink>
                </Button>
                <Button size="lg" variant="outlineWhite" asChild>
          ...
          <section className="py-12 bg-secondary/30">
            <div className="container mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
                <LocalizedLink to="pizza-muenchen" className="bg-card p-4 rounded-lg border border-border hover:border-primary transition-colors text-center">
                ...
                <LocalizedLink to="firmenfeier-muenchen" className="bg-card p-4 rounded-lg border border-border hover:border-primary transition-colors text-center">
...
export default ItalienerHauptbahnhofMuenchen;
