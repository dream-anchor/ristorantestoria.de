...
const ValentinstagMuenchen = ({ standalone, menu, archivedMenu, seasonalConfig }: ValentinstagMuenchenProps) => {
  ...
  if (standalone) {
    ...
    breadcrumbSchema = [
      { name: 'Home', url: '/' },
      { name: s.standaloneBreadcrumb || 'Valentinstag M\u00fcnchen', url: canonicalPath },
    ];
  } else {
  ...
  // --- Localized content for the new emotional sections (self-contained) ---
  const vxAll = {
    de: {
  ...
  const vx = vxAll[(language as 'de' | 'en' | 'it' | 'fr')] || vxAll.de;
  const HERO_IMG = "/valentinstag-hero-storia-muenchen.jpg";
  ...
  const relatedLinks = standalone ? [
    { title: s.standaloneRelated1Title, desc: s.standaloneRelated1Desc, to: "romantisches-dinner-muenchen" },
    { title: s.standaloneRelated2Title, desc: s.standaloneRelated2Desc, to: "aperitivo-muenchen" },
    { title: s.standaloneRelated3Title, desc: s.standaloneRelated3Desc, to: "speisekarte" },
    { title: s.standaloneRelated4Title, desc: s.standaloneRelated4Desc, to: "reservierung" },
    { title: s.standaloneRelated5Title, desc: s.standaloneRelated5Desc, to: "eventlocation-muenchen-maxvorstadt" },
    ...
    <>
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
          <img src={romantischesDinnerImage} srcSet={`${romantischesDinnerImage600} 600w, ${romantischesDinnerImage} 1200w`} sizes="100vw" alt={s.heroTitle} className="absolute inset-0 w-full h-full object-cover" loading="eager" fetchPriority="high" width={1200} height={800} />
          ...
          <article className="max-w-5xl mx-auto">
            ...
            <section className="mb-16 bg-primary text-primary-foreground rounded-xl p-8 text-center">
              ...
              <Button size="lg" variant="secondary" asChild>
                <a href="tel:+498951519696"><Phone className="w-5 h-5 mr-2" />{s.ctaBoxButton}</a>
              </Button>
              ...
              <section id="signup-form" className="mb-16 scroll-mt-24">
                <div className="bg-card rounded-lg border border-border p-8 md:p-12 text-center">
                  ...
                  <div className="max-w-md mx-auto">
                    <SeasonalSignupForm seasonalEvent="valentinstag" />
                  </div>
                </div>
              </section>
            )}
...
export default ValentinstagMuenchen;
